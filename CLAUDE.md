...
- **Pub. export…** — opens an options dialog (figure width: single col 3.5", double col 7.25", custom; DPI: 300/600; colour/greyscale; font size 7–10 pt; optional analysis table) and saves a publication-quality white-background PNG using `mpl.rc_context` (clean spines, inward ticks, 0.4 pt grid); greyscale mode uses hatched shading for dynamic regions for B&W print compatibility
